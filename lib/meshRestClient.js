...
var MeshRestClient = (function () {
     ...
     */
    MeshRestClient.prototype.getNavigationByPath = function (req, path, maxDepth, includeAll) {
    ...
    MeshRestClient.prototype.getNavigationByUUID = function (req, uuid, maxDepth, includeAll) {
    ...
    MeshRestClient.prototype.getChildren = function (req, uuid, lang, params) {
        var sort = (params && params.orderBy ? params.orderBy : "created"), query = { "filter": { "bool": { "must": [{ "term": { "parentNode.uuid": uuid } }], "_cache": true } }, "sort": {} };
        if (lang) {
