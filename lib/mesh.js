...
var Mesh = (function () {
     ...
     */
    Mesh.prototype.getChildren = function (req, uuid, lang, params) {
     ...
     */
    Mesh.prototype.getNavigationByPath = function (req, path, maxDepth, includeAll) {
     ...
     *          has been loaded and will be rejected if loading of the navigation object fails.
     */
    Mesh.prototype.getNavigationByUUID = function (req, uuid, maxDepth, includeAll) {
