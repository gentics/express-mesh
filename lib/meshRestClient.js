...
var MeshAuth = (function () {
     ...
     */
    MeshAuth.prototype.getAuthHeader = function (token) {
        return 'Bearer ' + token;
    };
    return MeshAuth;
})();
...
var MeshRestClient = (function () {
    ...
    MeshRestClient.prototype.meshSearch = function (req, query, projectName, params) {
    ...
    MeshRestClient.prototype.startsWith = function (str, word) {
    ...
    MeshRestClient.prototype.makeMeshRequest = function (requestOptions) {
        ...
        var starttime = Date.now(), req = client.request(options, function (res) {
            var data = '';
