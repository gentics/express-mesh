...
var MeshRestClient = (function () {
    ...
    MeshRestClient.prototype.getNavigationByPath = function (req, path, maxDepth) {
        var url = req.meshConfig.meshUrl + req.meshConfig.meshBase + req.meshConfig.meshProject + req.meshConfig.meshNavroot + path, params = new mesh_1.MeshQueryParams();
    ...
    MeshRestClient.prototype.getNavigationByUUID = function (req, uuid, maxDepth) {
        var url = req.meshConfig.meshUrl + req.meshConfig.meshBase + req.meshConfig.meshProject + MeshRestClient.NODES_ENDPOINT + uuid + MeshRestClient.NAVIGATION_ENDPOINT, params = new mesh_1.MeshQueryParams();
        params.maxDepth = maxDepth ? maxDepth : 10;
        return this.meshSimpleGET(req, url, params).then(function (response) {
            return response;
        });
