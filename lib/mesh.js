...
var Mesh = (function () {
     ...
     *          if the search fails.
     */
    Mesh.prototype.searchNodes = function (req, query, projectName, params) {
        return this.meshClient.meshSearch(req, query, projectName, params).then(function (response) {
    ...
    Mesh.prototype.getRequestHandler = function () {
        ...
        return function (req, res) {
            ...
            _this.meshClient.getWebrootNode(req, params).then(function (response) {
